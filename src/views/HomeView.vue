...
const columns = [
  ...
  { name: 'first_name', align: 'center', label: 'ชื่อจริง', field: 'first_name', sortable: true },
  ...
  { name: 'phone_number', align: 'center', label: 'เบอร์โทรศัพท์', field: 'phone_number', sortable: true },
